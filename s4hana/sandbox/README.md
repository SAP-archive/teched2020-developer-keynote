...
Visit the Kyma console (get there from your trial subaccount overview page and following the "Link to dashboard" link) and in the API Rules section, you'll see the relevant URL:
